...
// Generated from schema 'FirstProject' [0x988F7F7F]
...
static class TypeIds
{
	...
	public const uint InternalHaha = 0;

	public const uint InternalBam = 0;

	public const uint InternalBom = 1;

	public const uint InternalBim = 2;
...
{
	public const uint SchemaHash = 0x988F7F7F;
}
...
namespace Coherence.Generated.FirstProject
{
	...
	// EcsComponentData: InternalHahaData
	public struct Haha : IBufferElementData
	{
		public int x;
		public float y;
		public bool z;
	...
	public struct HahaRequest : IBufferElementData
	{
		public int x;
		public float y;
		public bool z;
...
#region Commands
            ...
            {
                var hasBuffer = entityManager.HasComponent<Haha>(entity);
                if (!hasBuffer)
                {
                    entityManager.AddBuffer<Haha>(entity);
                }
    
                var hasRequestBuffer = entityManager.HasComponent<HahaRequest>(entity);
                if (!hasRequestBuffer)
                {
                    entityManager.AddBuffer<HahaRequest>(entity);
                }
            }
...
public class MessageSerializers
{
	...
	public void Haha(IOutBitStream bitstream, Haha data)
	{

			
				bitstream.WriteIntegerRange(data.x, 15, -9999);
				...
				bitstream.WriteBool(data.z);
			

	}

	public void Bam(IOutBitStream bitstream, Bam data)
	{

			
				bitstream.WriteIntegerRange(data.strength, 15, -9999);
			

	}

	public void Bom(IOutBitStream bitstream, Bom data)
	{
	...
	public void Bim(IOutBitStream bitstream, Bim data)
	{
...
/// ------------------------ Requests --------------------------
	...
	public void HahaRequest(IOutBitStream bitstream, HahaRequest data)
	{
...
public class MessageDeserializers
{
	...
	public void Haha(IInBitStream bitstream, ref Haha data)
	{

			
				data.x =  bitstream.ReadIntegerRange(15, -9999);
				...
				data.z =  bitstream.ReadBool();
			
     
	}

	public void Bam(IInBitStream bitstream, ref Bam data)
	{

			
				data.strength =  bitstream.ReadIntegerRange(15, -9999);
			
     
	}

	public void Bom(IInBitStream bitstream, ref Bom data)
	{
	...
	public void Bim(IInBitStream bitstream, ref Bim data)
	{
	...
	public class PerformCommands : IPerformCommand
	{
		...
		public void PerformCommand(EntityManager mgr, Entity entity, uint commandTypeID, Coherence.Replication.Protocol.Definition.IInBitStream bitStream, ILog log)
		{
			...
			switch (commandTypeID)
			{
				...
				case TypeIds.InternalHaha:
				{
					var hasRequestBuffer = mgr.HasComponent<Haha>(entity);
					if (!hasRequestBuffer)
					{
						mgr.AddBuffer<Haha>(entity);
					}
					var buffer = mgr.GetBuffer<Haha>(entity);
					var data = new Haha();
					messageDeserializers.Haha(bitStream, ref data);
					buffer.Add(data);
					break;
				}
...
#region HahaRequest
			// ------------  HahaRequest --------------
            Entities
                .ForEach((Entity entity, DynamicBuffer<HahaRequest> buffer) =>
                    {
                        if (buffer.Length == 0)
                        {
                            return;
                        ...
                        for (var i=0; i<rawArray.Length; i++)
                        {
	                        ...
	                        messageSerializers.HahaRequest(protocol, item);
	                        // --------------------------------------------
...
namespace Coherence.Generated.FirstProject
{
	...
	public class EntityReplacer {
        ...
        // Command buffers
            ...
            if (entityManager.HasComponent<Haha>(source) &&
                !entityManager.HasComponent<Haha>(destination)) {
                entityManager.AddBuffer<Haha>(destination);
            }
            if (entityManager.HasComponent<HahaRequest>(source) &&
                !entityManager.HasComponent<HahaRequest>(destination)) {
                entityManager.AddBuffer<HahaRequest>(destination);
            }
...
namespace Coherence.Generated.FirstProject
{
	...
	// Event: InternalBam
	public struct Bam : IComponentData
	{
		public int strength;
	}
	...
	// Event: InternalBom
	public struct Bom : IComponentData
	{
		public int strength;
	}
	...
	// Event: InternalBim
	public struct Bim : IComponentData
	{
		public int strength;
	}
                ...
                .ForEach((Entity entity, in Bam eventComponent) =>
                    {
                        ...
                        messageSerializers.Bam(protocol, eventComponent);
                        // --------------------------------------------
                        ...
                        UnityEngine.Debug.Log("Will send Bam Event");
					}).WithoutBurst().Run();
                ...
                .ForEach((Entity entity, in Bom eventComponent) =>
                    {
                        ...
                        messageSerializers.Bom(protocol, eventComponent);
                        // --------------------------------------------
                        ...
                        UnityEngine.Debug.Log("Will send Bom Event");
					}).WithoutBurst().Run();
                ...
                .ForEach((Entity entity, in Bim eventComponent) =>
                    {
                        ...
                        messageSerializers.Bim(protocol, eventComponent);
                        // --------------------------------------------
                        ...
                        UnityEngine.Debug.Log("Will send Bim Event");
					}).WithoutBurst().Run();
...
namespace Coherence.Generated.Internal.FirstProject
{
	...
	public class DeleteEventSystem : SystemBase
	{
		protected override void OnUpdate()
		{
			...
			Entities
			   .WithAll<global::Coherence.Generated.FirstProject.Bam>()
			   .ForEach((Entity entity) =>
			{

				UnityEngine.Debug.Log("Will delete Bam Event component");
				EntityManager.RemoveComponent<Bam>(entity);
			}).WithStructuralChanges().Run();

			Entities
			   .WithAll<global::Coherence.Generated.FirstProject.Bom>()
			   .ForEach((Entity entity) =>
			{

				UnityEngine.Debug.Log("Will delete Bom Event component");
				EntityManager.RemoveComponent<Bom>(entity);
			}).WithStructuralChanges().Run();

			Entities
			   .WithAll<global::Coherence.Generated.FirstProject.Bim>()
			   .ForEach((Entity entity) =>
			{

				UnityEngine.Debug.Log("Will delete Bim Event component");
				EntityManager.RemoveComponent<Bim>(entity);
			}).WithStructuralChanges().Run();
