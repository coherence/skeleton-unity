...
// Generated from schema 'FirstProject' [0x92AFEC12]
...
static class TypeIds
{
	...
	public const uint InternalTeamMember = 6;

	public const uint InternalAssignToTeam = 0;
...
enum TypeEnums
{
	...
	InternalTeamMember = 6,

	InternalAssignToTeam = 0,
...
{
	public const uint SchemaHash = 0x92AFEC12;
}
...
namespace Coherence.Generated.FirstProject
{
	...
	// EcsComponentData: InternalTeamMemberData
	public struct TeamMember : IComponentData
	{
		public int Team;
	}
...
namespace Coherence.Generated.FirstProject
{
	...
	// EcsComponentData: InternalAssignToTeamData
	public struct AssignToTeam : IBufferElementData
	{
		public int Team;
	}

	public struct AssignToTeamRequest : IBufferElementData
	{
		public int Team;
	}
            ...
            Entity entity, uint[] foundComponentTypes, IOutBitStream bitStream, ILog log)
        {
            ...
            foreach (var coherenceComponentType in foundComponentTypes)
            {
				...
				switch (coherenceComponentType)
                {
                    ...
                    case TypeIds.InternalTeamMember:
					{
						var data = entityManager.GetComponentData<TeamMember>(entity);
						messageSerializers.TeamMember(protocolOutStream, data);
						break;
					}
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DeserializeComponentUpdateGenerated
    {
        ...
        private void DeserializeTeamMember(EntityManager entityManager, Entity entity, bool componentOwnership, AbsoluteSimulationFrame simulationFrame, Coherence.Replication.Protocol.Definition.IInBitStream protocolStream, bool justCreated, IInBitStream bitStream)
        {
			...
			// Overwrite components that don't use interpolation
			var componentData = entityManager.GetComponentData<TeamMember>(entity);
			unityReaders.Read(ref componentData, protocolStream);
			entityManager.SetComponentData(entity, componentData);
        ...
        public void ReadComponentDataUpdateEx(EntityManager entityManager, Entity entity, uint componentType, AbsoluteSimulationFrame simulationFrame, IInBitStream bitStream, bool justCreated, ILog log)
        {
			...
			case TypeIds.InternalTeamMember:
				DeserializeTeamMember(entityManager, entity, componentOwnership, simulationFrame, inProtocolStream, justCreated, bitStream);
				break;
...
#region Commands
            ...
            {
                var hasBuffer = entityManager.HasComponent<AssignToTeam>(entity);
                if (!hasBuffer)
                {
                    entityManager.AddBuffer<AssignToTeam>(entity);
                }
    
                var hasRequestBuffer = entityManager.HasComponent<AssignToTeamRequest>(entity);
                if (!hasRequestBuffer)
                {
                    entityManager.AddBuffer<AssignToTeamRequest>(entity);
                }
            }
            ...
            switch (componentType)
            {
                ...
                {
                    var justCreated = false;
                    var hasComponentData = entityManager.HasComponent<TeamMember>(entity);
                    var componentHasBeenRemoved = entityManager.HasComponent<TeamMember_Sync>(entity) && entityManager.GetComponentData<TeamMember_Sync>(entity).deletedAtTime > 0;
                    if (!hasComponentData && !componentHasBeenRemoved)
                    {
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DeserializeComponentUpdateSkipGenerated
    {
		...
		private void DeserializeTeamMember(Coherence.Replication.Protocol.Definition.IInBitStream protocolStream)
		{
            var ignored = new TeamMember();
            unityReaders.Read(ref ignored, protocolStream);
		}
		...
		public void SkipComponentDataUpdate(uint componentType, Coherence.Replication.Protocol.Definition.IInBitStream inProtocolStream, ILog log)
        {
			switch (componentType)
            {
                ...
                case TypeIds.InternalTeamMember:
					DeserializeTeamMember(inProtocolStream);
                    break;
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public struct TeamMember_Sync : IComponentData
    {
        public TeamMember lastSentData;
        public uint resendMask;
        public uint howImportantAreYou;
        public uint accumulatedPriority;
        public long deletedAtTime;
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class SerializeComponentUpdatesGenerated
    {
        ...
        private void SerializeTeamMember(EntityManager EntityManager, Entity entity, uint mask, IOutBitStream protocolOutStream)
        {
            ...
            // Reset accumulated priority so the same component is not sent again next frame
            var syncData = EntityManager.GetComponentData<TeamMember_Sync>(entity);
        ...
        public void SerializeComponent(EntityManager entityManager, Entity unityEntity, uint componentType, uint fieldMask, IOutBitStream protocolOutStream)
        {
            switch (componentType)
            {
                ...
                case TypeIds.InternalTeamMember:
                    SerializeTeamMember(entityManager, unityEntity, fieldMask, protocolOutStream);
                    break;
        ...
        public void UpdateDestructState(EntityManager entityManager, Entity unityEntity, uint componentTypeId)
        {
            switch (componentTypeId)
            {
                ...
                case TypeIds.InternalTeamMember:
                {
                    var syncData = entityManager.GetComponentData<TeamMember_Sync>(unityEntity);
                    syncData.deleteHasBeenSerialized = true;
                    entityManager.SetComponentData(unityEntity, syncData);
                    break;
                }
...
public class UnityReaders
{
	...
	public uint Read(ref TeamMember data, IInBitStream bitstream)
	{
		var propertyMask = (uint)0;
...
namespace Coherence.Generated.Internal.FirstProject
{
	...
	public class UnityWriters
	{
		...
		public void Write(in Rotation data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
		{
			...
			public void Write(in TeamMember data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
			{
	
				if (bitstream.WriteMask((propertyMask & 0x01) != 0))
				{
					
						bitstream.WriteIntegerRange(data.Team, 15, -9999);
...
public class MessageSerializers
{
	...
	public void TeamMember(IOutBitStream bitstream, TeamMember data)
	{
	...
	public void AssignToTeam(IOutBitStream bitstream, AssignToTeam data)
	{
...
/// ------------------------ Requests --------------------------
	...
	public void AssignToTeamRequest(IOutBitStream bitstream, AssignToTeamRequest data)
	{
...
public class MessageDeserializers
{
	...
	public void TeamMember(IInBitStream bitstream, ref TeamMember data)
	{

			
				data.Team =  bitstream.ReadIntegerRange(15, -9999);
	...
	public void AssignToTeam(IInBitStream bitstream, ref AssignToTeam data)
	{
	...
	public class PerformCommands : IPerformCommand
	{
		...
		public void PerformCommand(EntityManager mgr, Entity entity, uint commandTypeID, Coherence.Replication.Protocol.Definition.IInBitStream bitStream, ILog log)
		{
			...
			switch (commandTypeID)
			{
				...
				case TypeIds.InternalAssignToTeam:
				{
					var hasRequestBuffer = mgr.HasComponent<AssignToTeam>(entity);
					if (!hasRequestBuffer)
					{
						mgr.AddBuffer<AssignToTeam>(entity);
					}
					var buffer = mgr.GetBuffer<AssignToTeam>(entity);
					var data = new AssignToTeam();
					messageDeserializers.AssignToTeam(bitStream, ref data);
					buffer.Add(data);
					break;
				}
...
namespace Coherence.Sdk.Unity
{
	...
	public class CoherenceRuntimeSystem : ComponentSystem
	{
		protected override void OnCreate()
		{
           ...
           GlobalLookups.Register<TeamMember>(TypeEnums.InternalTeamMember);
           ...
           GlobalTypeIdLookups.Register<TeamMember>(TypeIds.InternalTeamMember);
...
#region AssignToTeamRequest
			// ------------  AssignToTeamRequest --------------
            Entities
                .ForEach((Entity entity, DynamicBuffer<AssignToTeamRequest> buffer) =>
                    {
                        if (buffer.Length == 0)
                        {
                            return;
                        }
                        var rawArray = buffer.Reinterpret<AssignToTeamRequest>();
                        
                        Debug.LogWarning($"I will send {rawArray.Length} AssignToTeamRequest commands to entity: {entity}");
						...
						for (var i=0; i<rawArray.Length; i++)
                        {
	                        ...
	                        // --------- Type Specific Part ---------------
	                        ComponentTypeIdSerializer.Serialize(TypeIds.InternalAssignToTeam, bitStream);
	                        messageSerializers.AssignToTeamRequest(protocol, item);
	                        // --------------------------------------------
	...
	public class ReceiveUpdate : IReceiveUpdate
	{
		...
		private void DestroyComponentData(EntityManager entityManager, Entity entity, uint componentType)
		{
			switch (componentType)
			{
				...
				case TypeIds.InternalTeamMember:
				{
					...
					if (hasComponentData)
					{
						entityManager.RemoveComponent<TeamMember>(entity);
					}
					break;
				}
		...
		public void UpdateResendMask(EntityManager entityManager, Coherence.Ecs.SerializeEntityID entityId, uint componentTypeId, uint fieldMask)
		{
			...
			switch (componentTypeId)
			{
				...
				case TypeIds.InternalTeamMember:
				{
					var hasComponentData = entityManager.HasComponent<TeamMember_Sync>(entity);
					if (hasComponentData)
					{
						var syncData = entityManager.GetComponentData<TeamMember_Sync>(entity);
		...
		public void UpdateHasReceivedConstructor(EntityManager entityManager, Coherence.Ecs.SerializeEntityID entityId, uint componentTypeId)
		{
			...
			switch (componentTypeId)
			{
				...
				case TypeIds.InternalTeamMember:
				{
					...
					{
						// Ownership may have been lost since the packet was sent
						log.Trace($"Sync component has been destroyed: {entity} TeamMember_Sync");
					}
					break;
				}
		...
		private void RemoveSyncComponents(EntityManager entityManager, Entity entity)
		{
			...
			if (entityManager.HasComponent<TeamMember_Sync>(entity))
			{
				entityManager.RemoveComponent<TeamMember_Sync>(entity);
			}
...
namespace Coherence.Generated.FirstProject
{
	...
	public class EntityReplacer {
		...
		private static void CopyComponents(EntityManager entityManager, Entity source, Entity destination)
		{
            ...
            if(entityManager.HasComponent<TeamMember>(source))
			{
		        // TeamMember has fields, will copy it.			
                if(!entityManager.HasComponent<TeamMember>(destination)) {
                    entityManager.AddComponentData<TeamMember>(destination, new TeamMember());
                }
				var data = entityManager.GetComponentData<TeamMember>(source);
				entityManager.SetComponentData<TeamMember>(destination, data);
        ...
        // Command buffers
            ...
            if (entityManager.HasComponent<AssignToTeam>(source) &&
                !entityManager.HasComponent<AssignToTeam>(destination)) {
                entityManager.AddBuffer<AssignToTeam>(destination);
            }
            if (entityManager.HasComponent<AssignToTeamRequest>(source) &&
                !entityManager.HasComponent<AssignToTeamRequest>(destination)) {
                entityManager.AddBuffer<AssignToTeamRequest>(destination);
            }
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DetectAddedComponentsSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities.WithAll<global::Coherence.Generated.FirstProject.TeamMember, CoherenceSimulateComponent>().WithNone<TeamMember_Sync>().ForEach((Entity entity) =>
			{

				EntityManager.AddComponentData(entity, new TeamMember_Sync 
				{
					howImportantAreYou = 600
				});
			}).WithStructuralChanges().Run();
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DetectChangedComponentsSystem : SystemBase
    {
	    protected override void OnUpdate()
	    {
			...
			Entities.ForEach((Entity entity, ref TeamMember_Sync sync, in global::Coherence.Generated.FirstProject.TeamMember data, in CoherenceSimulateComponent simulate) =>
			{
				uint mask = 0;
				if (!sync.hasBeenSerialized) 
				{ 
                ...
                if (data.Team != sync.lastSentData.Team) mask |= 0b00000000000000000000000000000001;
				...
				if (mask != 0 || sync.resendMask != 0)
				{
					...
					{
						entity = entity,
						componentType = TypeIds.InternalTeamMember,
						mask = mask,
						resendMask = sync.resendMask,
						entityHasReceivedConstructor = simulate.hasReceivedConstructor,
                        componentHasReceivedConstructor = sync.hasReceivedConstructor,
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DetectRemovedComponentsSystem : SystemBase
    {
        protected override void OnUpdate()
        {
			...
			Entities.WithNone<global::Coherence.Generated.FirstProject.TeamMember>().ForEach((Entity entity, ref TeamMember_Sync sync, in CoherenceSimulateComponent sim) =>
            {
                if (sync.deleteHasBeenSerialized)
                {
                    return;
