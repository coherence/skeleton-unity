...
// Generated from schema 'FirstProject' [0xF18BEDD9]
...
static class TypeIds
{
	...
	public const uint InternalAttach = 6;
...
{
	public const uint SchemaHash = 0xF18BEDD9;
}
...
namespace Coherence.Generated.FirstProject
{
	...
	// EcsComponentData: InternalAttachData
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DeserializeComponentUpdateGenerated
    {
        ...
        public static void ReadComponentDataUpdateEx(EntityManager entityManager, Entity entity, uint componentType, AbsoluteSimulationFrame simulationFrame, IInBitStream bitStream, bool justCreated, ILog log)
        {
			...
			case TypeIds.InternalAttach:
				DeserializeAttach(entityManager, entity, componentOwnership, simulationFrame, inProtocolStream, justCreated, bitStream);
				break;
...
#region Commands
            ...
            switch (componentType)
            {
                ...
                {
                    var justCreated = false;
                    var hasComponentData = entityManager.HasComponent<Attach>(entity);
                    var componentHasBeenRemoved = entityManager.HasComponent<Attach_Sync>(entity) && entityManager.GetComponentData<Attach_Sync>(entity).deletedAtTime > 0;
                    if (!hasComponentData && !componentHasBeenRemoved)
                    {
                        entityManager.AddComponentData(entity, new Attach());
                        justCreated = true;
                    }
    ...
    public class DeserializeComponentUpdateSkipGenerated
    {
		...
		public static void SkipComponentDataUpdate(uint componentType, Coherence.Replication.Protocol.Definition.IInBitStream inProtocolStream, ILog log)
        {
			switch (componentType)
            {
                ...
                case TypeIds.InternalAttach:
					DeserializeAttach(inProtocolStream);
                    break;
...
#region Detect Removed Component Data
			...
			Entities.WithNone<global::Coherence.Generated.FirstProject.Attach>().ForEach((Entity entity, ref Attach_Sync sync, in CoherenceSimulateComponent sim) =>
            {
                if (sync.deleteHasBeenSerialized)
                {
                    return;
                ...
                {
                    entity = entity,
                    componentType = TypeIds.InternalAttach,
                    mask = 0,
                    resendMask = 0,
                });
            }).ScheduleParallel();
...
#region Detect Added Component Data
			...
			Entities.WithAll<global::Coherence.Generated.FirstProject.Attach, CoherenceSimulateComponent>().WithNone<Attach_Sync>().ForEach((Entity entity) =>
			{
				
			
				EntityManager.AddComponentData(entity, new Attach_Sync 
				{
					howImportantAreYou = 600
				});
			}).WithStructuralChanges().Run();
...
#region Detect Component Data changes
			...
			Entities.ForEach((Entity entity, ref Attach_Sync sync, in global::Coherence.Generated.FirstProject.Attach data, in CoherenceSimulateComponent simulate) =>
			{
				uint mask = 0;
                ...
                if (data.parent != sync.lastSentData.parent) mask |= 0b00000000000000000000000000000001;
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public struct Attach_Sync : IComponentData
    {
        public Attach lastSentData;
        public uint resendMask;
        public uint howImportantAreYou;
        public uint accumulatedPriority;
        public long deletedAtTime;
    ...
    public static class SerializeComponentUpdatesGenerated
    {
        ...
        public static void SerializeComponent(EntityManager entityManager, Entity unityEntity, uint componentType, uint fieldMask, IOutBitStream protocolOutStream)
        {
            switch (componentType)
            {
                ...
                case TypeIds.InternalAttach:
                    SerializeAttach(entityManager, unityEntity, fieldMask, protocolOutStream);
                    break;
        ...
        public static void UpdateDestructState(EntityManager entityManager, Entity unityEntity, uint componentTypeId)
        {
            switch (componentTypeId)
            {
                ...
                case TypeIds.InternalAttach:
                {
                    var syncData = entityManager.GetComponentData<Attach_Sync>(unityEntity);
                    syncData.deleteHasBeenSerialized = true;
                    entityManager.SetComponentData(unityEntity, syncData);
                    break;
                }
...
namespace Coherence.Sdk.Unity
{
	...
	public class CoherenceRuntimeSystem : ComponentSystem
	{
		protected override void OnCreate()
		{
           ...
           GlobalLookups.Register<Attach>(TypeEnums.InternalAttach);
           ...
           GlobalTypeIdLookups.Register<Attach>(TypeIds.InternalAttach);
	...
	public class ReceiveUpdate : IReceiveUpdate
	{
		...
		private void DestroyComponentData(EntityManager entityManager, Entity entity, uint componentType)
		{
			switch (componentType)
			{
				...
				case TypeIds.InternalAttach:
				{
					...
					if (hasComponentData)
					{
						entityManager.RemoveComponent<Attach>(entity);
					}
					break;
				}
		...
		public void UpdateResendMask(EntityManager entityManager, Coherence.Ecs.SerializeEntityID entityId, uint componentTypeId, uint fieldMask)
		{
			...
			switch (componentTypeId)
			{
				...
				case TypeIds.InternalAttach:
				{
					var hasComponentData = entityManager.HasComponent<Attach_Sync>(entity);
					if (hasComponentData)
					{
						var syncData = entityManager.GetComponentData<Attach_Sync>(entity);
		...
		public void UpdateHasReceivedConstructor(EntityManager entityManager, Coherence.Ecs.SerializeEntityID entityId, uint componentTypeId)
		{
			...
			switch (componentTypeId)
			{
				...
				case TypeIds.InternalAttach:
				{
					...
					{
						// Ownership may have been lost since the packet was sent
						log.Trace($"Sync component has been destroyed: {entity} Attach_Sync");
					}
					break;
				}
		...
		private void RemoveSyncComponents(EntityManager entityManager, Entity entity)
		{
			...
			if (entityManager.HasComponent<Attach_Sync>(entity))
			{
				entityManager.RemoveComponent<Attach_Sync>(entity);
			}
...
namespace Coherence.Generated.FirstProject
{
	...
	using Unity.Transforms;
	using global::Coherence.Generated.FirstProject;
	using global::Coherence.Generated.Internal.FirstProject;
	using UnityEngine;
	...
	public class EntityReplacer {
		...
		private static void CopyComponents(EntityManager entityManager, Entity source, Entity destination)
		{
		    ...
		    // Attach has fields, will copy it.
			if(entityManager.HasComponent<Attach>(source))
			{
                if(!entityManager.HasComponent<Attach>(destination)) {
                    entityManager.AddComponentData<Attach>(destination, new Attach());
                }
				var data = entityManager.GetComponentData<Attach>(source);
				entityManager.SetComponentData<Attach>(destination, data);
			}
