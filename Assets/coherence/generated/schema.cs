...
static class TypeIds
{
	...
	public const uint InternalFoo = 5;
...
{
	public const uint SchemaHash = 0xCED29605;
}
...
namespace Coherence.Generated.FirstProject
{
	...
	// EcsComponentData: InternalFooData
            ...
            Entity entity, uint[] foundComponentTypes, IOutBitStream bitStream, ILog log)
        {
            ...
            foreach (var coherenceComponentType in foundComponentTypes)
            {
				...
				switch (coherenceComponentType)
                {
                    ...
                    case TypeIds.InternalFoo:
					{
						var data = entityManager.GetComponentData<Foo>(entity);
						MessageSerializers.Foo(protocolOutStream, data);
						break;
					}
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DeserializeComponentUpdateGenerated
    {
        ...
        private static void DeserializeFoo(EntityManager entityManager, Entity entity, bool componentOwnership, AbsoluteSimulationFrame simulationFrame, Coherence.Replication.Protocol.Definition.IInBitStream protocolStream, bool justCreated, IInBitStream bitStream)
        {
			// No need to read empty components
			if (((ComponentType)typeof(Foo)).IsZeroSized)
			{
				if (!entityManager.HasComponent<Foo>(entity))
				{
			...
			// Overwrite components that don't use interpolation
			var componentData = entityManager.GetComponentData<Foo>(entity);
			UnityReaders.Read(ref componentData, protocolStream);
			entityManager.SetComponentData(entity, componentData);
        ...
        public static void ReadComponentDataUpdateEx(EntityManager entityManager, Entity entity, uint componentType, AbsoluteSimulationFrame simulationFrame, IInBitStream bitStream, bool justCreated, ILog log)
        {
			...
			case TypeIds.InternalFoo:
				DeserializeFoo(entityManager, entity, componentOwnership, simulationFrame, inProtocolStream, justCreated, bitStream);
				break;
...
#region Commands
            ...
            switch (componentType)
            {
                ...
                {
                    var justCreated = false;
                    var hasComponentData = entityManager.HasComponent<Foo>(entity);
                    var componentHasBeenRemoved = entityManager.HasComponent<Foo_Sync>(entity) && entityManager.GetComponentData<Foo_Sync>(entity).deletedAtTime > 0;
                    if (!hasComponentData && !componentHasBeenRemoved)
                    {
                        entityManager.AddComponentData(entity, new Foo());
                        justCreated = true;
                    }
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public class DeserializeComponentUpdateSkipGenerated
    {
		...
		private static void DeserializeFoo(Coherence.Replication.Protocol.Definition.IInBitStream protocolStream)
		{
            var ignored = new Foo();
            UnityReaders.Read(ref ignored, protocolStream);
		}
		...
		public static void SkipComponentDataUpdate(uint componentType, Coherence.Replication.Protocol.Definition.IInBitStream inProtocolStream, ILog log)
        {
			switch (componentType)
            {
                ...
                case TypeIds.InternalFoo:
					DeserializeFoo(inProtocolStream);
                    break;
...
#region Detect Removed Component Data
			...
			Entities.WithNone<global::Coherence.Generated.FirstProject.Foo>().ForEach((Entity entity, ref Foo_Sync sync, in CoherenceSimulateComponent sim) =>
            {
                if (sync.deleteHasBeenSerialized)
                {
                    return;
                ...
                {
                    entity = entity,
                    componentType = TypeIds.InternalFoo,
                    mask = 0,
                    resendMask = 0,
                });
            }).ScheduleParallel();
...
#region Detect Added Component Data
			...
			Entities.WithAll<global::Coherence.Generated.FirstProject.Foo, CoherenceSimulateComponent>().WithNone<Foo_Sync>().ForEach((Entity entity) =>
			{
				
			
				EntityManager.AddComponentData(entity, new Foo_Sync 
				{
					howImportantAreYou = 600
				});
			}).WithStructuralChanges().Run();
...
#region Detect Component Data changes
			...
			Entities.ForEach((Entity entity, ref Foo_Sync sync, in global::Coherence.Generated.FirstProject.Foo data, in CoherenceSimulateComponent simulate) =>
			{
				sync.accumulatedPriority += sync.howImportantAreYou;
                ...
                if (!data.pos.Equals(sync.lastSentData.pos) ) mask |= 0b00000000000000000000000000000001;



                if (data.age != sync.lastSentData.age) mask |= 0b00000000000000000000000000000010;
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public struct Foo_Sync : IComponentData
    {
        public Foo lastSentData;
        public uint resendMask;
        public uint howImportantAreYou;
        public uint accumulatedPriority;
        public long deletedAtTime;
...
namespace Coherence.Generated.Internal.FirstProject
{
    ...
    public static class SerializeComponentUpdatesGenerated
    {
        ...
        private static void SerializeFoo(EntityManager EntityManager, Entity entity, uint mask, IOutBitStream protocolOutStream)
        {
            ...
            // Reset accumulated priority so the same component is not sent again next frame
            var syncData = EntityManager.GetComponentData<Foo_Sync>(entity);
        ...
        public static void SerializeComponent(EntityManager entityManager, Entity unityEntity, uint componentType, uint fieldMask, IOutBitStream protocolOutStream)
        {
            switch (componentType)
            {
                ...
                case TypeIds.InternalFoo:
                    SerializeFoo(entityManager, unityEntity, fieldMask, protocolOutStream);
                    break;
        ...
        public static void UpdateDestructState(EntityManager entityManager, Entity unityEntity, uint componentTypeId)
        {
            switch (componentTypeId)
            {
                ...
                case TypeIds.InternalFoo:
                {
                    var syncData = entityManager.GetComponentData<Foo_Sync>(unityEntity);
                    syncData.deleteHasBeenSerialized = true;
                    entityManager.SetComponentData(unityEntity, syncData);
                    break;
                }
...
public static class UnityReaders
{
	...
	public static uint Read(ref Foo data, IInBitStream bitstream)
	{
		var propertyMask = (uint)0;
		...
		{
			var coherenceField = bitstream.ReadVector3f(24, 2400);
			     data.pos = CoherenceToUnityConverters.ToUnityfloat3(coherenceField);
			propertyMask |= 0b00000000000000000000000000000001;
		}
            if (bitstream.ReadMask()) 
		{
			var coherenceField = bitstream.ReadFixedPoint(24, 40000);
			     data.age = CoherenceToUnityConverters.ToUnityfloat(coherenceField);
			propertyMask |= 0b00000000000000000000000000000010;
		}
...
namespace Coherence.Generated.Internal.FirstProject
{
	...
	public static class UnityWriters
	{
		public static void Write(in Translation data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
		{
			...
			public static void Write(in Foo data, uint propertyMask, Coherence.Replication.Protocol.Definition.IOutBitStream bitstream)
			{
	
				if (bitstream.WriteMask((propertyMask & 0x01) != 0))
				{
					
						var v = CoherenceToUnityConverters.FromUnityfloat3(data.pos);
						bitstream.WriteVector3f(v, 24, 2400);
				...
				if (bitstream.WriteMask((propertyMask & 0x01) != 0))
				{
						...
						var v = CoherenceToUnityConverters.FromUnityfloat(data.age);
						bitstream.WriteFixedPoint(v, 24, 40000);
...
public static class MessageSerializers
{
	...
	public static void Foo(IOutBitStream bitstream, Foo data)
	{

			
				var converted_pos = CoherenceToUnityConverters.FromUnityfloat3(data.pos);
				bitstream.WriteVector3f(converted_pos, 24, 2400);
			

			
				var converted_age = CoherenceToUnityConverters.FromUnityfloat(data.age);
				bitstream.WriteFixedPoint(converted_age, 24, 40000);
...
public static class MessageDeserializers
{
	...
	public static void Foo(IInBitStream bitstream, ref Foo data)
	{

			
				var pos = bitstream.ReadVector3f(24, 2400);
				data.pos = CoherenceToUnityConverters.ToUnityfloat3(pos);
			

			
				var age = bitstream.ReadFixedPoint(24, 40000);
				data.age = CoherenceToUnityConverters.ToUnityfloat(age);
...
namespace Coherence.Sdk.Unity
{
	...
	public class CoherenceRuntimeSystem : ComponentSystem
	{
		protected override void OnCreate()
		{
           ...
           GlobalLookups.Register<Foo>(TypeEnums.InternalFoo);
           ...
           GlobalTypeIdLookups.Register<Foo>(TypeIds.InternalFoo);
    ...
    public class ReceiveUpdate : IReceiveUpdate
    {
        ...
        public void UpdateResendMask(EntityManager entityManager, Coherence.Ecs.EntityId entityId, uint componentTypeId, uint fieldMask)
        {
            ...
            switch (componentTypeId)
            {
                ...
                case TypeIds.InternalFoo:
                {
                    var hasComponentData = entityManager.HasComponent<Foo_Sync>(entity);
                    if (hasComponentData)
                    {
                        var syncData = entityManager.GetComponentData<Foo_Sync>(entity);
		...
		public void UpdateHasReceivedConstructor(EntityManager entityManager, Coherence.Ecs.EntityId entityId, uint componentTypeId)
		{
            ...
            switch (componentTypeId)
            {
                ...
                case TypeIds.InternalFoo:
                {
                    ...
                    {
						// Ownership may have been lost since the packet was sent
                        log.Trace($"Sync component has been destroyed: {entity} Foo_Sync");
                    }
                    break;
                }
        ...
        private void RemoveSyncComponents(EntityManager entityManager, Entity entity)
        {
            ...
            if (entityManager.HasComponent<Foo_Sync>(entity)) 
            {
                entityManager.RemoveComponent<Foo_Sync>(entity);
            }
