...
namespace Coherence.Generated
{
	...
	public class CoherenceLimits : MonoBehaviour
	{
		...
		// Component name: SessionBased
		
	
		
		// Component name: Transferable
		
		// participant : int
		
		public static readonly int Transferable_participant_Min = -9999;
		public static readonly int Transferable_participant_Max = 9999;
